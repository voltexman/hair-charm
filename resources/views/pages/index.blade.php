...
@section('header')
    <div x-data="slideshow" x-init="autoplay"
        ...
        <div
            ...
            <div class="flex justify-between mb-5 px-5 lg:px-10 relative z-20">
                ...
                <a href="#top" class="cursor-pointer animate-bounce block group" aria-label="Scroll to products section">
...
@section('content')
    ...
    <x-section class="bg-center bg-no-repeat bg-cover overflow-hidden section-2"
        ...
        <div class="max-w-xl lg:max-w3xl mx-auto text-center space-y-10 relative">
            ...
            <div class="relative z-0 text-charm-dark-400 font-[Boldonse] text-xl md:text-2xl/9 tracking-wide">
                Where can you get true<br><span class="text-charm-brown-600">Russian hair</span>,
                which will<br>last year after year?
            </div>
            <div class="flex items-center gap-2.5">
                <div class="relative flex size-12 justify-center items-center">
                    <span
                        class="absolute inline-flex size-9 animate-ping rounded-full bg-charm-brown-400 opacity-75"></span>
                    <span
                        class="relative inline-flex size-12 rounded-full bg-charm-cream-100 border border-dashed border-charm-brown-200 justify-center items-center">
                        <x-lucide-arrow-down class="relative z-10 size-7 stroke-charm-brown-800" stroke-width="1.1" />
                    </span>
                </div>
                <div class="text-charm-dark-400 font-[Poppins] text-xl/5 font-medium">
                    Let us tell<br class="md:hidden"> <span class="text-charm-dark-400">your</span> our
                    <span class="text-charm-brown-600 font-bold secret-label-anim inline-block">secret</span>!
                </div>
            </div>
        </div>
    </x-section>
    ...
    <x-section class="bg-charm-cream-100 justify-center items-center overflow-hidden relative section-3">
        <img src="{{ Vite::asset('resources/images/icons/woman-hair-cut.svg') }}"
            ...
            alt="">
        <div class="max-w-xl lg:max-w-2xl mx-auto space-y-5 relative z-10">
            <x-section.title tag="h2">
                <x-slot:first>Russian</x-slot> hair <br> extensions
            ...
            <x-section.content>
                <p><x-marker variant="font">{{ env('APP_NAME') }}</x-marker> is one of the leaders in market for selling
                    ...
                    the best quality possible. If you need a direct <span class="font-semibold">Russian hair extensions
    ...
    <section class="bg-charm-cream-100 flex flex-col overflow-hidden chess-board section-4">
        <div
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-3">
            <div class="order-2 md:order-2 xl:order-2 chess-board-cell">
            ...
            <div class="order-4 md:order-3 xl:order-4 chess-board-cell">
            ...
            <div class="order-6 md:order-6 xl:order-6 chess-board-cell">
    ...
    <x-section class="bg-charm-cream-100 flex items-center relative section-5">
        <img src="{{ Vite::asset('resources/images/icons/curled-black-long-female-hair-shape.svg') }}"
            class="size-[80%] absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 opacity-5 z-0 ghost-image"
            alt="">
    ...
    <x-section class="bg-charm-dark-400 overflow-hidden dual-box section-6">
    ...
    <x-section class="bg-charm-cream-200 overflow-hidden section-7">
        <div class="max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto grid lg:grid-cols-2 gap-10">
            <div>
    ...
    <x-section class="bg-charm-dark-400 section-8">
        <div class="max-w-xl lg:max-w-3xl xl:max-w-3xl mx-auto grid md:grid-cols-3">
            <div class="md:col-span-2 space-y-10">
                <div class="font-[Boldonse] text-xl md:text-3xl/10 text-charm-cream-100 text-balance box-top">
                    Separately it is necessary allocate manufacturing strands on a tape hair.
                </div>
                <div
                    class="font-[Oswald] text-3xl/8 md:text-5xl/10 lg:text-6xl/12 text-charm-cream-100 font-light md:font-thin text-balance box-bottom">
    ...
    <x-section class="bg-charm-cream-200 overflow-hidden dual-box section-9">
        <div class="max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto grid md:grid-cols-2 gap-x-10 gap-y-20">
            <div class="font-[Oswald] text-xl md:text-2xl lg:text-4xl font-light text-gray-800 text-balance box-left">
                Most manufacturers for these goods are located in China, which products non virgin hair. Accordingly,
                <i>99%</i> of their products are made from Asian materials, which are sold as natural Slavic,
                <span class="font-[Boldonse] text-2xl">THEY ARE NOT SELLING YOU TRUE SLAVIC HAIR</span>.
            </div>
            <div>
                <img src="https://www.hair-charm.com/images/main/two_line/1.jpg" class="object-cover" alt="">
            </div>
            <div>
    ...
    <x-section class="bg-cover bg-fixed bg-center relative overflow-hidden section-10"
        style="background-image: url('{{ Vite::asset('resources/images/bg-children-section-1.png') }}')">
        ...
        <div class="max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto space-y-5 relative z-10">
            <h2 class="text-charm-cream-100 font-[Boldonse] text-3xl md:text-5xl mb-5">
                <span class="font-[Lora] text-4xl md:text-6xl italic font-semibold">Children`s</span> Hair
            </h2>
            <div class="max-w-xl font-[Lora] text-xl text-charm-cream-100">
    ...
    <x-section class="bg-charm-cream-200 overflow-hidden dual-box section-11">
        <div class="max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto">
            <x-section.title class="mb-10 text-center">
                <x-slot:first>Wholesale</x-slot>. Virgin<br>Russian
    ...
    <x-section class="bg-charm-cream-100 overflow-hidden dual-box section-12">
        <div class="max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto">
            <x-section.title class="mb-10 text-center" tag="h4">
                ...
                <x-slot:last><x-marker color="dark">payment</x-marker></x-slot>
            </x-section.title>
            <div class="grid lg:grid-cols-2 gap-5">
                <div
                    class="font-[Oswald] text-black/60 uppercase text-lg lg:text-xl font-bold md:text-end box-left text-balance text-justify">
                    {{ env('APP_NAME') }} has been working for a long time in the industry of
                    <span class="text-black selected inline-block">Russian hair</span>, payment and delivery of goods are
                ...
                <div class="font-[Poppins] text-gray-800 box-right">
                    ...
                    <p>If you are searching of a reliable supplier of human hair
                        <span class="font-normal italic">(Russian virgin)</span> you need
