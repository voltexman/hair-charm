...
@section('content')
    <div class="span">
        <section id="top" x-intersect:enter="showProductsButton = false" x-intersect:leave="showProductsButton = true"
            x-init="showProductsButton = false" class="snap-start lg:h-screen bg-charm-dark-400 flex flex-col">
            <div
                class="grow flex flex-col lg:flex-row lg:items-center mx-auto lg:max-w-6xl px-5 py-10 lg:p-0 gap-10 lg:gap-60">
                <div
                    class="text-3xl lg:text-4xl font-[Boldonse] uppercase text-charm-cream-200 tracking-wider leading-12 flex">
                ...
                <div class="hidden lg:flex flex-col gap-y-2.5">
                    <div class="font-[Lora] text-white text-lg italic">
            ...
            <x-product-section.list class="border-y-6 border-charm-cream-300 overflow-hidden">
                ...
                <x-product-section.item class="z-7"
                    image="https://www.hair-charm.com/templates/jblank/images/bg/blocks/pre-bonded-hair.jpg"
                    :link="route('products.pre-bonded-hair')">
                    <x-slot:title>
                        Pre Bonded Hair
                    </x-slot>
                    <x-slot:caption>
        ...
        <section class="lg:h-screen bg-charm-dark-400 flex flex-col justify-center items-center">
            <div class="grid lg:grid-cols-5 px-5 py-20 lg:p-0 mx-auto lg:max-w-6xl gap-10 lg:gap-40">
                <div class="lg:col-span-3 text-2xl lg:text-3xl lg:text-5xl text-white duration-1500"
                ...
                <div class="lg:col-span-2 text-2xl lg:text-3xl text-white font-black flex flex-col justify-between h-full">
                    <div class="text-white/60 duration-2000"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-top')">Where can you get true
                        <span class="text-white">Russian hair</span>, which will last year after year?
                    </div>
                    <img src="{{ Vite::asset('resources/images/icons/woman-hair-extended-in-front-of-the-head-light.svg') }}"
                        class="h-35 me-auto duration-2500" x-intersect="$el.classList.add('animate-in', 'fade-in')"
                        alt="">
                    <div class="text-white/60 text-3xl lg:text-4xl duration-1500"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-bottom')">
                        Let us tell <span class="text-white">your</span> our <span class="text-white">secret</span>!
                    </div>
                </div>
            </div>
        </section>
        ...
        <section
            class="lg:h-screen relative bg-charm-cream-100 grid gap-y-10 justify-center items-center overflow-hidden py-20 lg:py-0">
            <img src="{{ Vite::asset('resources/images/icons/woman-hair-cut.svg') }}"
                class="size-[80%] absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 opacity-5 z-0" alt="">
            <div class="max-w-3xl mx-auto px-5 z-10 relative">
                ...
                <p class="font-[Lora] font-semibold text-lg text-black/90">
                    <span class="bg-black/80 px-1.5 py-0.5 text-white uppercase">{{ env('APP_NAME') }}</span> is one of the
                    leaders in market for selling REAL <b>raw virgin hair</b>. Our employees make various products from
                    them. We are based in Ukraine, work directly with donors and collect "Slavic hair", which we inspect to
                    ensure the best quality possible. If you need a direct <b>Russian hair extensions supplier</b> of
                    quality goods, without second-hand dealers, then our company is exactly what you were looking for.
                </p>
                <p class="font-[Lora] font-semibold text-lg text-black/90">
        ...
        <section class="lgh-screen bg-charm-cream-100 flex flex-col overflow-hidden">
            <div
                class="font-[Boldonse] w-full p-5 lg:px-0 bg-charm-dark-400 flex items-center text-white uppercase tracking-wide lg:tracking-widest flex-none">
                <div class="mx-auto max-w-2xl duration-1500"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-left')">
            ...
            <div class="grid lg:grid-cols-3 lg:grid-rows-2 lg:grow">
                <div class="order-2">
                    <img src="https://www.hair-charm.com/images/main/krug/1_img.jpg"
                        class="object-cover size-full duration-1500" alt=""
                        x-intersect="$el.classList.add('animate-in', 'fade-in')">
                </div>
                <div class="relative font-[Lora] font-semibold lg:text-lg self-center px-5 py-10 lg:px-10 2xl:p-20 uppercase font-medium order-1 duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'fade-in', 'zoom-in-75')">
                    <div
                        class="hidden lg:block absolute -left-7 bottom-1/2 -translate-y-1/2 border-14 border-transparent border-e-charm-cream">
                    </div>
                    <span class="bg-black/80 px-1.5 py-1 text-white uppercase">One of the most important</span> pluses is
                    working only with non-mixed strands. Our principle - "one person - one bulk hair". Therefor, we achieve
                    a homogeneous structure of material, our goods are exclusively remy hair extensions. As a result, we get
                    a combed quality cut hair that fully complies with the world standards and is ready to hair extension or
                ...
                <div class="relative font-[Lora] font-semibold lg:text-lg self-center px-5 py-10 lg:px-15 2xl:p-30 uppercase font-medium order-3 duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'fade-in', 'zoom-in-75')">
                    <div
                        class="hidden lg:block absolute -right-7 bottom-1/2 translate-y-1/2 border-14 border-transparent border-s-charm-cream">
                    </div>
                    <span class="bg-black/80 px-1.5 py-1 text-white uppercase">Second important</span>
                ...
                <div class="relative font-[Lora] font-semibold lg:text-lg self-center px-5 py-10 lg:px-15 2xl:p-30 uppercase font-medium order-5 duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'fade-in', 'zoom-in-75')">
                    <div
                    ...
                    <span class="bg-black/80 px-1.5 py-1 text-white uppercase">Third</span>, what separates us from other
                    companies? It is material that is collected from donors. It must intact, healthy, with perfect
                    structure.
                    Subsequently, you get a product that does not have damaged scales and looks real on the client's head.
                </div>
            </div>
        </section>

        <section class="lg:h-screen bg-charm-cream-100 flex items-center py-20 lg:py-0 relative">
            <img src="{{ Vite::asset('resources/images/icons/curled-black-long-female-hair-shape.svg') }}"
                class="size-[80%] absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 opacity-2.5 z-0"
                alt="">
            <div class="max-w-2xl mx-auto px-5 lg:px-0 relative z-10">
                <h2 class="text-2xl lg:text-4xl uppercase drop-shadow-lg mb-10 duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-top')">
                ...
                <div class="text-sm lg:text-base font-black uppercase text-gray-700 mt-10 duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-bottom')">
        ...
        <section
            class="lg:h-screen bg-charm-dark-400 flex flex-col justify-center items-center py-20 lg:p-0 overflow-hidden">
            <div class="lg:max-w-6xl lg:mx-auto grid lg:grid-cols-[1fr_auto_2fr] px-5 lg:p-0 gap-10">
                <div>
                    <h2 class="text-3xl lg:text-4xl text-white uppercase drop-shadow-lg mb-10 duration-2000"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-top')">
                        Hair extensions manufacture
                    </h2>

                    <div class="font-[Oswald] text-white/50 leading-6 lg:leading-8 tracking-wide uppercase text-xl font-bold duration-1500"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-left')">
                        <x-marker variant="light">{{ env('APP_NAME') }}</x-marker>
                ...
                <div class="w-full h-2 lg:w-2 lg:h-full bg-white duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-bottom')">
                </div>

                <div class="font-[Lora] text-white/90 text-xl lg:text-2xl duration-1500"
        ...
        <section class="lg:h-screen bg-charm-cream-100 flex justify-center items-center py-20 lg:-0 overflow-hidden">
            <div class="lg:max-w-6xl lg:mx-auto grid lg:grid-cols-[1fr_auto_2fr] px-5 lg:p-0 gap-10 items-stretch">
                <div>
                    <h2 class="text-3xl lg:text-4xl uppercase drop-shadow-lg mb-10 duration-2000"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-top')">
                        Wholesale.<br> Virgin Russian hair
                    </h2>

                    <div class="font-[Oswald] text-black/60 leading-6 lg:leading-8 tracking-wide uppercase text-xl font-bold duration-1500"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-left')">
                ...
                <div class="w-full h-2 lg:w-2 lg:h-full bg-charm-dark-500 duration-2000"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-bottom')">
                </div>

                <div class="font-[Lora] text-black text-xl lg:text-2xl duration-1500"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-right')">
        ...
        <section class="lg:h-screen bg-charm-dark-400 flex justify-center items-center py-20 lg:py-0 overflow-hidden">
            <div class="lg:max-w-6xl lg:mx-auto grid lg:grid-cols-[1fr_auto_2fr] px-5 lg:p-0 gap-10 items-stretch">
                <div>
                    <h2 class="text-3xl lg:text-4xl text-white uppercase drop-shadow-lg mb-10 duration-2000"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-top')">
                    ...
                    <div class="font-[Oswald] text-white/50 leading-6 lg:leading-8 tracking-wide uppercase text-xl font-black duration-1500"
                        x-intersect="$el.classList.add('animate-in', 'slide-in-from-left')">
                ...
                <div class="font-[Lora] text-white/90 lg:font-light text-xl lg:text-2xl duration-1500"
                    x-intersect="$el.classList.add('animate-in', 'slide-in-from-right')">
