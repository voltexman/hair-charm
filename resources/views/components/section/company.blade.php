<div class="flex flex-col justify-center items-center self-center h-full">
    <img src="{{ Vite::asset('resources/images/icons/logo-dark.svg') }}" class="size-50 drop-shadow-lg" alt="">
